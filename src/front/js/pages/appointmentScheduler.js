					...
					<div className="card p-4">
						...
						<form>
							...
							<div className="form-group">
								...
								<input type="text" className="form-control" id="filtroNombre" placeholder="Filtrar por nombre" />
							</div>
							<div className="form-group">
								
								<input type="text" className="form-control" id="filtroDni" placeholder="Filtrar por DNI" />
							</div>
							<div className="form-group">
